...
**Live dashboard:** `https://avaranda-code.github.io/prototype-playground`
...
```bash
# Clone it locally
git clone https://github.com/avaranda-code/prototype-playground.git
...
```bash
GITHUB_USERNAME="avaranda-code"    # ← put your actual username here
```
...
**Dashboard:** `https://avaranda-code.github.io/prototype-playground`
